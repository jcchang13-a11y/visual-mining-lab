...
(function(){
  ...
  const specs=[
    ...
    {
      key:'retro-30390-17-3-direct',
      src:'figures/retro-30390-17-3.svg',
      caption:'第十七分重新演出第三分「滅度一切眾生，而無一眾生實滅度」與四相不得成立的基本結構：17 → 3',
      anchor:'發阿耨多羅三藐三菩提心、展開滅度一切眾生行動的善男子、善女人，不會因此自動成為菩薩。'
    },
    {
    ...
    {
      key:'retro-30390-17-10-zhuangyan',
      src:'figures/retro-30390-17-10-zhuangyan.svg',
      caption:'第十七分補註明說「莊嚴佛土」是第十分舊例子，並在「我當莊嚴佛土」處再次叫回：17 → 10',
      anchor:'第十分已經說過：「莊嚴佛土者，即非莊嚴，是名莊嚴。」第十七分再把它叫回來：「我當莊嚴佛土，是不名菩薩。」'
    },
    {
