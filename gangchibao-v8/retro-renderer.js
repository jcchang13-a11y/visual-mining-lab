...
(function(){
  ...
  const KNOWN_RETRO_FIGURES={
    '30260B':[
      {
        ...
        caption:'第八分在進場前回頭重建「法」這條線：8 → 7 → 6 → 4 → 3',
        anchor:'第八分開始前，要先回頭看「法」這條線，不然這一分很容易被讀成一個簡單的功德排行榜：布施很大，但受持四句偈、為人說更大；物質布施比較低，佛法比較高。這樣讀太快了。'
      }
    ],
    '30340':[
      {
    ...
    '30370':[
      ...
      {
        key:'retro-30370-15-13-11-8',
        src:'figures/retro-30370-15-13-11-8.svg',
        caption:'第十五分把「為人說／為人解說」與福德比較線重新接回第十三、十一、八分：15 → 13 → 11 → 8',
        anchor:'「為人解說」前面已經多次出現。第八分有「於此經中受持，乃至四句偈等，為他人說，其福勝彼」；第十一分有「於此經中，乃至受持四句偈等，為他人說，而此福德勝前福德」；第十三分尾又把「以恆河沙等身命布施」與「於此經中，乃至受持四句偈等、為人說，其福甚多」並列。第十五分的「何況書寫、受持、讀誦、為人解說」不是突然開啟新主題，而是把這條已經反覆出現的線接到「其福勝彼」之後。'
      }
    ],
    '30390':[
      {
    ...
    '30430':[
      ...
      {
        key:'retro-30430-20-body',
        src:'figures/retro-30430-20.svg',
        caption:'第二十分把具足色身／諸相問題接回前面的身體與見如來線：20 → 17 → 10 → 5 → 1',
      ...
      },
      {
        ...
        caption:'第二十二分把說法／得法問題接回第二十一與第十七分：22 → 21 → 17',
      ...
      },
      {
        ...
        caption:'第二十三分把無所得／無高下接回第二十二與第七分：23 → 22 → 7',
        anchor:'第二十二分剛說無有少法可得。第二十三分接著說無有高下。'
      },
      {
        key:'retro-30430-24-23-19-16',
        src:'figures/retro-30430-24-23-19-16.svg',
        caption:'第二十四分把高下與福德比較重新接回第二十三、第十九、第十六分：24 → 23 → 19 → 16',
        anchor:'第二十四分是第十九分的回收。'
      }
    ],
    '30440':[
      {
