 ...
 * 長鏈保留；第十三分正文同時叫回第十二、十一分時，另補逐點直接回返。
 */
(function(){
  'use strict';
  const unit=new URLSearchParams(location.search).get('u');
  if(unit!=='30310B') return;
  const sharedAnchor='到了第十三分，須菩提問：「世尊，當何名此經？我等云何奉持？」這個問題不是單純問書名。前面已經把此經的福德、場所、供養、佛在場全部推起來了，現在問題自然變成：那這部經到底叫什麼？我們要怎麼承受它、保存它、流傳它？';
  const specs=[
    {
    ...
    {
      key:'retro-30310B-13-12',
      src:'figures/retro-30310B-13-12.svg',
      caption:'第十三分問「當何名此經、云何奉持」，直接回看第十二分已把經典所在之處、供養與佛在場推高的現場：13 → 12',
      anchor:sharedAnchor
    },
    {
      key:'retro-30310B-13-11',
      src:'figures/retro-30310B-13-11.svg',
      caption:'第十三分問經名與奉持，也直接回看第十一分把此經福德與七寶布施推到宇宙尺度的比較：13 → 11',
      anchor:sharedAnchor
    },
    {
