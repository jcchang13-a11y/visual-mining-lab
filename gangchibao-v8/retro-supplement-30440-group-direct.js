 ...
 * 2026-09-13 續接：正文另明示「知一切法無我，得成於忍」回接第十四、十五分忍辱線；
 * 長鏈 28 → 15 → 14 保留，再把 28 → 14／15 逐一拆成直接回扣。
 */
(function(){
  'use strict';
  ...
  const specs=[
    ...
    },
    {
      ...
      caption:'第二十八分「知一切法無我，得成於忍」直接回扣第十四分忍辱線：28 → 14',
      anchor:'「知一切法無我，得成於忍」可回接第十四、十五分的忍辱線。'
    },
    {
      key:'retro-30440-28-15-direct',
      src:'figures/retro-30440-28-15.svg',
      caption:'第二十八分「知一切法無我，得成於忍」直接回扣第十五分忍辱線：28 → 15',
      anchor:'忍不是單純忍耐，也不是受苦美德'
    }
  ];
