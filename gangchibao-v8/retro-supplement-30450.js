  ...
  const specs=[
    {
      ...
      caption:'第二十九分一出現，正文即明說整部經轉身回看第一分的來去坐臥：29 → 1',
    ...
    },
    {
      ...
      caption:'第二十九分把「不能以行動定位如來」接回第二十一分「不能把如來說法做成實有」的同一抓取問題：29 → 21',
    ...
    },
    {
      ...
      caption:'第三十二分拒絕把末偈讀成舒服的終極結論，直接承接第三十一分對診斷位置與固定見解的最後拆解：32 → 31',
    ...
    },
    {
      ...
      caption:'第三十二分以「不取於相」的演說方法直接回扣第四分「不住於相」的無住施工線：32 → 4',
      anchor:'這就是最後的答案。不是不說，而是不取於相地說。不是躲進沉默，而是在演說中不住相。不是把經變成一套可交付的「法」，也不是把自己變成說經功德很大的主體，而是說的時候，不取於相，如如不動。'
    },
    {
      key:'retro-30450-32-21',
      src:'figures/retro-30450-32-21.svg',
      caption:'第三十二分仍要求為人演說，卻拒絕把經做成可交付的「法」，回扣第二十一分對「如來有所說法」的拆解：32 → 21',
      anchor:'這就是最後的答案。不是不說，而是不取於相地說。不是躲進沉默，而是在演說中不住相。不是把經變成一套可交付的「法」，也不是把自己變成說經功德很大的主體，而是說的時候，不取於相，如如不動。'
    },
    {
