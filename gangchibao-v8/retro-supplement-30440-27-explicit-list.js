...
(function(){
  ...
  const specs=[
    ...
    {
      key:'retro-30440-28-11-reading-repeat',
      src:'figures/retro-30440-28-11.svg',
      caption:'第二十八分在正文再次明說「把第十一分恆河沙數量放大叫回來」的位置重現回溯：28 → 11',
      anchor:'前面第十一分用恆河沙把數量推到爆掉，現在第二十八分再把這個宇宙級布施叫回來。'
    },
    {
      key:'retro-30440-28-19-reading-repeat',
      src:'figures/retro-30440-28-19.svg',
      caption:'第二十八分在「福德可以作，但不能受」的實際閱讀位置再次回扣第十九分福德無實：28 → 19',
      anchor:'這一點要和第十九分一起讀。'
    },
    {
      key:'retro-30440-28-24-reading-repeat',
      src:'figures/retro-30440-28-24.svg',
      caption:'第二十八分在註釋明說與第二十四分互讀的位置再次回扣此經功德比較：28 → 24',
      anchor:'第二十八分應與第十九分、第二十四分互讀。'
    }
  ];
