...
check(gut.version==='0.2.7','GUT_VERSION',gut.version);
...
let active=null;
try{
  active=await runActiveExecutorLoop({rounds:3,seed:'GUT v0.2.7 feedback validation',mineQuery:'NOSTROMO',verifyUrl:'https://github.com/jcchang13-a11y/visual-mining-lab'});
