...
check(gut.version==='0.2.18','GUT_VERSION',gut.version);
...
let active=null;
try{
  active=await runActiveExecutorLoop({rounds:3,seed:'GUT v0.2.18 feedback validation',mineQuery:'NOSTROMO',verifyUrl:'https://github.com/jcchang13-a11y/visual-mining-lab'});
...
const result={
  schema:'nostromo-gut-metabolism-test/v0.2.18',completedAt:new Date().toISOString(),status:failures.length===0?'PASS':'FAIL',
