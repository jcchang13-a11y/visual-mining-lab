...
const result={
  schema:'nostromo-vajra-conflict-escalation-test/v0.7.0',completedAt:new Date().toISOString(),status:failures.length?'FAIL':'PASS',
  guards:{
  ...
  boundary:'PASS proves deterministic conflict escalation, packet-correlated return intake, same-intake and cross-intake replay containment, plus content-bound history attestation: bare known packet IDs may conservatively block replay but cannot manufacture historical completion; historical completion requires packet scope, provenance, substantive returned material and target relation whose content recomputes to the carried returnKey. Contentless or post-acceptance-mutated records remain unattested. This is deterministic structural lineage integrity, not cryptographic authenticity, semantic adjudication, source independence proof or truth closure.'
};
