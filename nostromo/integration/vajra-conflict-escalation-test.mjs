...
const result={
  ...
  boundary:'PASS proves deterministic conflict escalation, packet-correlated return intake, same-intake and cross-intake replay containment, plus history-attestation separation: bare known packet IDs may conservatively block replay but cannot manufacture historical completion or allPacketsReturned; only structurally matching accepted records can carry completion across intakes. Unknown and malformed historical ledger entries are excluded from accepted lineage. This is deterministic structural attestation, not cryptographic authenticity, semantic adjudication, source independence proof or truth closure.'
};
