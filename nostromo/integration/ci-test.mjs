// NOSTROMO repository-native integration CI v0.3.1
...
const result={
  schema:'nostromo-integration-ci/v0.3.1',
...
await fs.writeFile(path.join(integrationBase,'ci-last-result.json'),JSON.stringify(result,null,2)+'\n','utf8');
