// VAJRA receipt ambiguity/conflict guard v0.5.5
...
// forms without crossing sentence or semicolon boundaries. Concessive/contrastive coverage masks
// directional vocabulary only inside a bounded comma-delimited prefix, so
