// VAJRA receipt ambiguity/conflict guard v0.5.14
...
// and bounded non-nested parenthetical asides.
...
function maskParentheticalPolarityPhrases(text){
  ...
  // arrive here as ASCII parentheses. Deliberately bounded and non-nested.
  return text.replace(/\([^()\n]{0,240}\)/g,mask);
}
