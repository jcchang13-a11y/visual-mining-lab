// VAJRA receipt ambiguity/conflict guard v0.5.2
...
// Conditionality coverage includes bounded condition-prefix forms without crossing
// sentence boundaries. This is deterministic audit logic, not semantic adjudication,
...
function maskConditionalPolarityPhrases(text){
  ...
  // Prefix form: "Only if X, this evidence supports Y". The bounded scan is barred
  // from crossing sentence/semicolon boundaries so a condition in a previous sentence
  // cannot suppress a later unconditional relation.
  out=out
