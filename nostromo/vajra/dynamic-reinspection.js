/* VAJRA dynamic reinspection capability v0.1 — receipt feedback changes next inspection priority without altering source evidence */
(function(root){
  ...
  function wrapped(vajraResult,receipts=[]){
    ...
    return {...out,nextInspection,dynamicReinspection:{version:'0.1',triggered:nextInspection?.trigger==='CONTESTED_RETURN',policy:'CONFLICT_FIRST_SOURCE_QUALITY',boundary:'A qualifying inter-organ receipt conflict changes VAJRA next-step behavior by prioritizing source-quality reinspection. Missing, malformed, replayed, or otherwise rejected receipts cannot trigger this escalation.'}};
  }
