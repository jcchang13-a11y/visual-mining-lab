...
const result={schema:'zenomorph-vajra-dynamic-multiparent-test/v0.4',completedAt:new Date().toISOString(),status:failures.length?'FAIL':'PASS',capability:'QUALIFYING_RECEIPT_SCOPED_MULTI_PARENT_DYNAMIC_DECOMPOSITION',tests:{bFromAB,bFromBA,aFromAB,multiAB,multiBA,poisonResults,unscoped,wrongScope},provenance:{fixture:'synthetic de-identified multi-parent contested state',failureEvidence:'nostromo/failure-log/2026-09-09-vajra-nonqualifying-receipt-target-poisoning.json'},failures,boundary:'PASS proves only that current VAJRA v1.3 preserves qualifying completed GUT contamination-triage control over multi-parent target selection while diagnostic replay identity is tightened. Non-GUT, incomplete, provenance-empty, and unauthorized-classification receipts remain auditable without manufacturing target multiplicity; genuine qualifying receipts targeting two parents still HOLD. It does not execute facets, decide source truth, or admit a capability into persistent body state.'};
